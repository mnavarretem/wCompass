% Function fn_topomap
% fn_topomap()  plots a topographic map of an EEG field as a 2-D
...
%
% Inspired and modified from the original topoplot version by Andy Spydell 
% and topomaps by Mike X. Cohen
