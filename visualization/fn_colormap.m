...
switch lower(ch_scheme)
    ...
    case 'groundblue'
        mx_baseMap = fn_funDivGroundBlue;
    case 'groundgreen'
        mx_baseMap = fn_funDivGroundGreen;
    case 'bluegreen'
        mx_baseMap = fn_funDivBlueGreen;
    case 'seqygb'
    ...
    case 'divgrwg'
        mx_baseMap = fn_funDivGrWG;
    case 'divgrwb'
        mx_baseMap = fn_funDivGrWB;
    otherwise
        try 
            mx_baseMap = cmocean(lower(ch_scheme));
        catch
            try
                mx_baseMap = othercolor(ch_scheme,nm_numel);
            catch
                error(['[fn_colormap] - Invalid color scheme ' ch_scheme])
            end
        end
end
...
%% Sub-functions 
    function mx_baseMap = fn_funDivGroundBlue
        mx_baseMap	=  [0.4549    0.2392    0.0118;
                        0.5098    0.3098    0.0941;
                        0.5608    0.3804    0.1725;
                        0.6157    0.4510    0.2431;
                        0.6667    0.5216    0.3216;
                        0.7216    0.5961    0.3961;
                        0.7725    0.6706    0.4745;
                        0.8235    0.7451    0.5529;
                        0.8745    0.8235    0.6353;
                        0.9294    0.9020    0.7176;
                        0.9804    0.9804    0.8039;
                        0.8824    0.9098    0.7882;
                        0.7882    0.8392    0.7686;
                        0.7020    0.7725    0.7412;
                        0.6118    0.7020    0.7137;
                        0.5255    0.6353    0.6824;
                        0.4431    0.5686    0.6471;
                        0.3569    0.5059    0.6118;
                        0.2706    0.4392    0.5765;
                        0.1686    0.3765    0.5373;
                             0    0.3176    0.4980];
        
    end
    function mx_baseMap = fn_funDivGroundGreen
         mx_baseMap	=  [0.4549    0.2392    0.0118;
                        0.5098    0.3098    0.0941;
                        0.5608    0.3804    0.1725;
                        0.6157    0.4510    0.2431;
                        ...
                        0.9294    0.9020    0.7176;
                        0.9804    0.9804    0.8039;
                        0.8784    0.9137    0.7412;
                        0.7804    0.8471    0.6784;
                        0.6824    0.7804    0.6157;
                        0.5882    0.7137    0.5529;
                        0.4980    0.6471    0.4941;
                        0.4078    0.5804    0.4314;
                        0.3176    0.5176    0.3725;
                        0.2275    0.4549    0.3176;
                        0.1333    0.3922    0.2588;
                             0    0.3294    0.2039];
    end
    function mx_baseMap = fn_funDivBlueGreen
         mx_baseMap	=  [0.0549    0.3059    0.4667
                        0.1804    0.3686    0.5137
                        0.2706    0.4353    0.5647
                        0.3569    0.5020    0.6157
                        0.4392    0.5725    0.6667
                        0.5255    0.6431    0.7176
                        0.6118    0.7137    0.7725
                        0.7020    0.7843    0.8275
                        0.7961    0.8588    0.8824
                        0.8941    0.9294    0.9412
                        1.0000    1.0000    1.0000
                        0.8980    0.9294    0.9020
                        0.7961    0.8627    0.8078
                        0.6980    0.7922    0.7176
                        0.6039    0.7255    0.6314
                        0.5137    0.6588    0.5529
                        0.4235    0.5882    0.4745
                        0.3373    0.5216    0.4000
                        0.2510    0.4549    0.3333
                        0.1608    0.3922    0.2706
                        0.0627    0.3255    0.2118];
    end
    ...
    function mx_baseMap = fn_funDivGrWG
        mx_baseMap	=  flipud([0,0.6000,0
                    0.0510,0.6196,0.0510
                    0.1020,0.6392,0.1020
                    0.1490,0.6588,0.1490
                    0.2000,0.6784,0.2000
                    0.2510,0.6980,0.2510
                    0.2980,0.7216,0.2980
                    0.3490,0.7412,0.3490
                    0.4000,0.7608,0.4000
                    0.4510,0.7804,0.4510
                    0.5020,0.8000,0.5020
                    0.5490,0.8196,0.5490
                    0.6000,0.8392,0.6000
                    0.6510,0.8588,0.6510
                    0.6980,0.8784,0.6980
                    0.7490,0.9020,0.7490
                    0.8000,0.9216,0.8000
                    0.8510,0.9412,0.8510
                    0.9020,0.9608,0.9020
                    0.9490,0.9804,0.9490
                    1.0000,1.0000,1.0000
                    0.9490,0.9608,0.9490
                    0.9020,0.9216,0.9020
                    0.8510,0.8784,0.8510
                    0.8000,0.8392,0.8000
                    0.7490,0.8000,0.7490
                    0.6980,0.7608,0.6980
                    0.6510,0.7216,0.6510
                    0.6000,0.6784,0.6000
                    0.5490,0.6392,0.5490
                    0.5020,0.6000,0.5020
                    0.4510,0.5608,0.4510
                    0.4000,0.5216,0.4000
                    0.3490,0.4784,0.3490
                    0.3020,0.4392,0.3020
                    0.2510,0.4000,0.2510
                    0.2000,0.3608,0.2000
                    0.1490,0.3216,0.1490
                    0.0980,0.2784,0.0980
                    0.0510,0.2392,0.0510
                    0,0.2000,     0]);
    end

    function mx_baseMap = fn_funDivGrWB
        mx_baseMap	= flipud([0,0.2000,0.8000
                    0.0510,0.2392,0.8118
                    0.1020,0.2784,0.8196
                    0.1490,0.3216,0.8314
                    0.2000,0.3608,0.8392
                    0.2510,0.4000,0.8510
                    0.2980,0.4392,0.8588
                    0.3490,0.4784,0.8706
                    0.4000,0.5216,0.8784
                    0.4510,0.5608,0.8902
                    0.5020,0.6000,0.9020
                    0.5490,0.6392,0.9098
                    0.6000,0.6784,0.9216
                    0.6510,0.7216,0.9294
                    0.6980,0.7608,0.9412
                    0.7490,0.8000,0.9490
                    0.8000,0.8392,0.9608
                    0.8510,0.8784,0.9686
                    0.9020,0.9216,0.9804
